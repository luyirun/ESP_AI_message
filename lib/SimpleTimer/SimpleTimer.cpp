...
int SimpleTimer::setTimer(long d, timer_callback f, int arg, int n) {
    int freeTimer;
...
int SimpleTimer::setInterval(long d, timer_callback f, int arg) {
    return setTimer(d, f, arg, RUN_FOREVER);
}


int SimpleTimer::setTimeout(long d, timer_callback f, int arg) {
    return setTimer(d, f, arg, RUN_ONCE);
}
