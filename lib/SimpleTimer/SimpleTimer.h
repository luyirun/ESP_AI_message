...
typedef void (*timer_callback)(int arg);
...
public:
    ...
    int setInterval(long d, timer_callback f, int arg);

    // call function f once after d milliseconds
    int setTimeout(long d, timer_callback f, int arg);

    // call function f every d milliseconds for n times
    int setTimer(long d, timer_callback f, int arg, int n);
...
private:
    ...
    // arguments for the callback functions
    int args[MAX_TIMERS];
